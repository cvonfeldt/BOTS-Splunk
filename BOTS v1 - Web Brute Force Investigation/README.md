# 01 - Boss of the SOC (BOTS) v1 - Website Defacement Investigation with Sigma Rules, Process Lineage and MITRE ATT&CK analysis
...
| Time | Event |
|------|-------|
| 21:36:48 | 40.80.148.42 scans imreallynotbatman.com using Acunetix; server returns HTTP 200 to 2 scans |
